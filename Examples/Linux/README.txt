...
gcc -DLINUX -std=gnu99 FirstTimeInetConfig.c cInet.c cModemInterface.c cModemStream.c -o FirstTimeInetConfig
...
gcc -DLINUX -std=gnu99 mmcat.c cInet.c cModemInterface.c cModemStream.c -o mmcat
