/* Listens for incoming text messages and executes commands depending on their content.
   ...
   Usage: the program is run on the drone's BB. It should begin listening on boot. 
          To accomplish this, add the following lines to etc/rc.local:
     sudo su
...
/* Print the last 5 received messages */
